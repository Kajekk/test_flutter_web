...
class AgreementDataSource extends DataTableSource {
  AgreementDataSource({required this.controller});
  ...
  DataRow? getRow(int index) {
    ...
    final _data = controller.dataList.cast<Agreement>()[index - controller.firstRowIndex];
