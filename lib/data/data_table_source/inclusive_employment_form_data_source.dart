...
class InclusiveEmploymentDataSource extends DataTableSource {
  InclusiveEmploymentDataSource({required this.controller});
  final InclusiveEmploymentController controller;
  ...
  DataRow? getRow(int index) {
    ...
    final _data = controller.dataList.cast<InclusiveEmploymentForm>()[index - controller.firstRowIndex];
