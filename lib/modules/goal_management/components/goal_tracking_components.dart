...
import 'package:test_flutter_web/modules/goal_management/controllers/barrel.dart';

class GoalTrackingItemDetailInfo extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    EditGoalTrackingController controller = Get.find();
    return Obx(() {
