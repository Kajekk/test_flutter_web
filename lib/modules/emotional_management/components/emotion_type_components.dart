...
class EmotionTypeItemDetailInfo extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    EditEmotionTypeController controller = Get.find();
    return Obx(() {
        ...
        children: [
          ...
          Text.rich(TextSpan(children: [
            TextSpan(
                text: "Group: \n",
                style: Theme.of(context).textTheme.subtitle1),
            TextSpan(text: controller.itemDetail!.group),
          ])),
          SizedBox(
            height: defaultPadding / 2,
          ),
          Text.rich(TextSpan(children: [
            TextSpan(
                ...
                style: Theme.of(context).textTheme.subtitle1),
            TextSpan(
                text: controller.itemDetail!.isEnabled.toString()),
          ])),
        ],
      );
    });
...
class EmotionTypeDialog extends StatelessWidget {
  final controller = Get.find<AddNewEmotionTypeController>();
  ...
  void _submitForm() {
    if (_key.currentState!.validate()) {
      ...
      controller.addNewItem(EmotionType(
                  ...
                  Form(
                    ...
                    child: Column(
                      children: [
                        ...
                        if (controller.state is AddEmotionTypeLoading)
                          SizedBox(
                            width: 70,
                        ...
                        if (controller.state is AddEmotionTypeFailure)
                          Padding(
                            padding: const EdgeInsets.only(top: 10.0),
                            child: Text(
                              (controller.state as AddEmotionTypeFailure)
                                  .message,
...
class EditEmotionTypeDialog extends StatelessWidget {
  final controller = Get.find<EditEmotionTypeController>();
  final GlobalKey<FormState> _key = GlobalKey<FormState>();
  ...
  void _submitForm() {
    if (_key.currentState!.validate()) {
      controller.editItem(EmotionType(
