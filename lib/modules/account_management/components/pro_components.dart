...
class ProAccountItemDetailInfo extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    EditProAccountController controller = Get.find();
    return Obx(() {
...
class AddProDialog extends StatelessWidget {
  final AddNewProAccountController controller = Get.find();
                  ...
                  Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (controller.state is AddProAccountFailure)
                          Padding(
                            padding: EdgeInsets.only(top: defaultPadding / 2),
                            child: Align(
                                alignment: Alignment.center,
                                child: Text(
                                  (controller.state as AddProAccountFailure)
                                      .message,
...
class EditProDialog extends StatelessWidget {
  final EditProAccountController controller = Get.find();
  final OrganisationController organisationController = Get.find();
  final RoleController roleController = Get.find();
  final GlobalKey<FormState> _key = GlobalKey<FormState>();
