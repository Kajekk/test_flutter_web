...
class PwdAccountItemDetailInfo extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    EditPwdAccountController controller = Get.find();
    return Obx(() {
...
class AddPwdDialog extends StatelessWidget {
  final AddNewPwdAccountController controller = Get.find();
                  ...
                  Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (controller.state is AddPwdAccountFailure)
                          Padding(
                            padding: EdgeInsets.only(top: defaultPadding / 2),
                            child: Align(
                                alignment: Alignment.center,
                                child: Text(
                                  (controller.state as AddPwdAccountFailure)
                                      .message,
...
class EditPwdDialog extends StatelessWidget {
  final EditPwdAccountController controller = Get.find();
  final OrganisationController organisationController = Get.find();
  final RoleController roleController = Get.find();
  final GlobalKey<FormState> _key = GlobalKey<FormState>();
                  ...
                  Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (controller.state is EditPwdAccountFailure)
                          Padding(
                            padding: EdgeInsets.only(top: defaultPadding / 2),
                            child: Align(
                                alignment: Alignment.center,
                                child: Text(
                                  (controller.state as EditPwdAccountFailure)
                                      .message,
                                  style: TextStyle(color: Get.theme.errorColor),
                                )),
                          ),
