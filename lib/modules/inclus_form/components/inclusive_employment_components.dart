...
class ContactUsDetailInfo extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    EditContactUsController controller = Get.find();
    return Obx(() {
        ...
        children: [
          ...
          Text.rich(TextSpan(children: [
            TextSpan(
                text: "Number: \n",
                style: Theme.of(context).textTheme.subtitle1),
            TextSpan(text: controller.itemDetail!.number),
          ])),
          SizedBox(
            height: defaultPadding / 2,
          ),
          Text.rich(TextSpan(children: [
            TextSpan(
                text: "Message: \n",
                style: Theme.of(context).textTheme.subtitle1),
            TextSpan(text: controller.itemDetail!.message),
          ])),
          SizedBox(
            height: defaultPadding / 2,
          ),
